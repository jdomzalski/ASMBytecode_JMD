...
public class GenCmp{
    ...
    public static void main(String[] args){
        ...
        cw.visit(Opcodes.V1_8, Opcodes.ACC_PUBLIC,"CmpNumbers",null,"java/lang/Object",null);
...

        {
            ...
            // Loading and comparing two ints and storing/printing the result
            mv.visitLdcInsn(5);
            ...
            // Loading and comparing two longs and storing/printing the result
            ...
            // Loading and comparing two doubles and storing/printing the result
        ...
        writeFile(b,"gen1.java.program4.class");
